      ...
      <div className="flex items-center gap-2">
        ...
        {showSave && onSave && (
          <button
            ...
            disabled={isSaving}
            className={cn(
              'inline-flex items-center gap-2 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 transition-colors',
        ...
        {/* Complete Button */}
        {showComplete && onComplete && !isCompleted && (
          <button
            onClick={onComplete}
            disabled={isCompleting}
            className={cn(
              'inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-colors',
              'hover:bg-blue-700',
              'disabled:cursor-not-allowed disabled:opacity-50'
            )}
          >
